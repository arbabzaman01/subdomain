      ...
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          'bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out ' +
            ...
            'z-50 max-h-[calc(var(--radix-dropdown-menu-content-available-height))] ' +
            'min-w-[8rem] w-auto sm:min-w-[8rem] md:min-w-[10rem] lg:min-w-[12rem] ' +
            'origin-[var(--radix-dropdown-menu-content-transform-origin)] overflow-x-hidden ' +
    ...
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground " +
          ...
          "rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[inset]:pl-8 [&_svg]:pointer-events-none " +
          "[&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    ...
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        'bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out ' +
          ...
          'data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[8rem] w-auto sm:min-w-[8rem] md:min-w-[10rem] ' +
          'lg:min-w-[12rem] origin-[var(--radix-dropdown-menu-content-transform-origin)] ' +
